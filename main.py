...
# Theme Colors (Sakura / Japanese Landscape inspired)
LINE_COLOR = (59, 31, 56)          # Dark tree trunk purple
BG_COLOR = (234, 182, 210)        # Soft pink sky (fallback)
X_COLOR = (215, 66, 119)          # Vibrant blossom pink
O_COLOR = (255, 230, 240)         # Lightest pink blossom
TEXT_COLOR = (255, 255, 255)       # Pure white
BUTTON_COLOR = (113, 62, 114)      # Muted mountain purple
BUTTON_HOVER_COLOR = (138, 83, 139) # Lighter mountain purple
...
pygame.display.set_caption("Tic Tac Toe - Sakura Edition")
